                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('description') is-invalid @enderror" type="text"
                                               name="description" value="{{$about->description}}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('job') is-invalid @enderror" type="text"
                                               name="job" value="{{$about->job}}" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('text') is-invalid @enderror" type="text"
                                                  name="text"  required>{{$about->text}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('start_date') is-invalid @enderror"
                                               type="date"
                                               name="start_date" value="{{\Illuminate\Support\Carbon::parse($about->start_date)->format('Y-m-d') }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('end_date') is-invalid @enderror"
                                               type="date"
                                               name="end_date" value="{{\Carbon\Carbon::parse($about->end_date)->format('Y-d-m') }}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">

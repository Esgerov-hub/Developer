                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('url') is-invalid @enderror" type="text"
                                               name="url" value="{{ $project->url }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('text') is-invalid @enderror"
                                                  type="text" name="text"  required>{{ $project->text }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div  class="col-sm-6">
                                    <div class="form-group">
                                        <label for="image">Image</label>
                                            ...
                                            <input class="form-control" type="file" value="{{ $project->image }}" name="image">
                                        ...
                                        <div class="project-members">
                                            <a data-placement="top" data-toggle="tooltip"
                                               class="avatar">
                                                ...
                                                <img id="image" src="{{ asset( \Illuminate\Support\Facades\Storage::url($project->image)) }}"/>
                                            </a>
                                        </div>
                                    </div>
                                </div>

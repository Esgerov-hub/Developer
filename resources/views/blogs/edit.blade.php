            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <a class="btn btn-primary submit-bt" href="{{ route('blogs.index')  }}"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('text') is-invalid @enderror" type="text"
                                                  name="text"  required>{{ $blog->text }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div id="wrapper" class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('image') is-invalid @enderror"
                                               ...
                                               value="{{\Illuminate\Support\Facades\Storage::url($blog->image)}}" required>
                                    </div>
                                </div>
                                <div id="wrapper" class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="project-members">
                                            <a data-placement="top" data-toggle="tooltip"
                                               class="avatar">
                                                ...
                                                <img id="image" src="{{\Illuminate\Support\Facades\Storage::url($blog->image)}}"/>
                                            </a>
                                        </div>
                                    </div>
                                </div>
